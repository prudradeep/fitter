...
INSERT INTO evaluation_questions (category, sort_order, question, active) VALUES
  ...
  ('The transformative impact', 1, '**Effect on identified negative impacts**: To what extent does this mitigation measure directly address your selected hazard? (stronger weight for this category 30%?)\n\n- 1 = No clear relevance to the identified problem\n- 5 = Partially relevant; addresses only some aspects\n- 10 = Direct, strong alignment with the defined problems\n', TRUE),
  ('The transformative impact', 2, '**Systemic Effects**: To what extent is the initiative likely to generate positive systemic impacts across multiple sectors or policy domains?\n\n- 1 = No systemic effects; isolated impact and not positive ones\n- 5 = Some cross-sector spillovers, moderate systemic relevance and positive impacts\n- 10 = Broad, transformative positive systemic effects across multiple domains (e.g. economic, environmental, social, institutional)\n', TRUE),
  ('The transformative impact', 3, '**Rules of the Game**: To what extent does the initiative reshape regulatory frameworks or institutional arrangements?\n\n- 1 = No institutional or regulatory changes\n- 5 = Moderate adjustments to existing rules or institutional practices\n- 10 = Significant structural changes to governance, regulation, or institutional behavior\n', TRUE),
  ('The transformative impact', 4, '**Paradigms & Attitudes**: To what extent could the initiative shift political priorities, paradigms, or public attitudes?\n\n- 1 = No influence on political discourse or priorities\n- 5 = Moderate potential to influence debates or agendas\n- 10 = Strong potential to shift paradigms, narratives, or long-term political priorities\n', TRUE),
  ('The transformative impact', 5, '**Overall Final Equity Dimension**: To what extent does the initiative reduce social or regional inequalities in the green or digital transition?\n\n- 1 = Risk of increasing existing inequalities\n- 5 = Limited or mixed equity effects\n- 10 = Strong, targeted reduction of inequalities (e.g., affordability, accessibility, distributional fairness)\n', TRUE),
  ('Feasibility and Implementation', 1, '**Barriers**: How feasible is the initiative given existing political, cultural, and financial constraints (reverse-coded: higher score = fewer obstacles)\n\n- 1 = Severe political, cultural, financial, or administrative barriers\n- 5 = Moderate obstacles that require negotiation or adaptation\n- 10 = Very few obstacles; high political, cultural, and financial compatibility\n', TRUE),
  ('Feasibility and Implementation', 2, '**Timing**: How suitable is the current moment for implementing this initiative (in terms of readiness, preconditions, and alignment with policy cycles)?\n\n- 1 = Cannot be implemented under current conditions; major prerequisites missing\n- 5 = Some prerequisites missing, partial readiness\n- 10 = Fully implementable immediately with no major preconditions\n', TRUE)
