...
CREATE TABLE IF NOT EXISTS custom_hazards (
  ...
  CONSTRAINT fk_custom_hazards_region FOREIGN KEY (region_id) REFERENCES regions(id) ON DELETE SET NULL,
  CONSTRAINT fk_custom_hazards_created_by FOREIGN KEY (created_by_user_id) REFERENCES app_users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS custom_hazard_profiles (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_custom_hazard_profiles_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS user_hazards (
  ...
  CONSTRAINT fk_user_hazards_custom_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE SET NULL,
  ...
  INDEX ix_user_hazards_custom_hazard_id (custom_hazard_id),
...
CREATE TABLE IF NOT EXISTS user_hazard_socio_demographics (
  ...
  evidence TEXT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_user_hazard_dgs_session FOREIGN KEY (user_session_id) REFERENCES user_sessions(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_hazard_dgs_hazard FOREIGN KEY (user_hazard_id) REFERENCES user_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_hazard_dgs_custom_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_hazard_dgs_system_hazard FOREIGN KEY (system_hazard_id) REFERENCES system_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_hazard_dgs_additional_hazard FOREIGN KEY (additional_hazard_id) REFERENCES additional_hazards(id) ON DELETE CASCADE,
  ...
  INDEX ix_user_hazard_socio_demographics_user_session_id (user_session_id),
  INDEX ix_user_hazard_socio_demographics_hazard_id (user_hazard_id),
  INDEX ix_user_hazard_socio_demographics_custom_hazard_id (custom_hazard_id),
  INDEX ix_user_hazard_socio_demographics_system_hazard_id (system_hazard_id),
  INDEX ix_user_hazard_socio_demographics_additional_hazard_id (additional_hazard_id),
...
CREATE TABLE IF NOT EXISTS user_mitigation_measures (
  ...
  is_crowd_sourced BOOLEAN NOT NULL DEFAULT FALSE,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_user_mitigation_measures_session FOREIGN KEY (user_session_id) REFERENCES user_sessions(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_mitigations_hazard FOREIGN KEY (user_hazard_id) REFERENCES user_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_mitigation_measures_custom_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_mitigation_measures_system_hazard FOREIGN KEY (system_hazard_id) REFERENCES system_hazards(id) ON DELETE CASCADE,
  CONSTRAINT fk_user_mitigation_measures_additional_hazard FOREIGN KEY (additional_hazard_id) REFERENCES additional_hazards(id) ON DELETE CASCADE,
  INDEX ix_user_mitigation_measures_user_session_id (user_session_id),
  INDEX ix_user_mitigation_measures_hazard_id (user_hazard_id),
  INDEX ix_user_mitigation_measures_custom_hazard_id (custom_hazard_id),
...
CREATE TABLE IF NOT EXISTS user_question_responses (
  ...
  CONSTRAINT fk_user_question_responses_custom_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE SET NULL,
  CONSTRAINT fk_user_question_responses_system_hazard FOREIGN KEY (system_hazard_id) REFERENCES system_hazards(id) ON DELETE SET NULL,
  CONSTRAINT fk_user_question_responses_additional_hazard FOREIGN KEY (additional_hazard_id) REFERENCES additional_hazards(id) ON DELETE SET NULL,
  ...
  INDEX ix_user_question_responses_custom_hazard_id (custom_hazard_id),
  INDEX ix_user_question_responses_system_hazard_id (system_hazard_id),
  INDEX ix_user_question_responses_additional_hazard_id (additional_hazard_id),
...
CREATE TABLE IF NOT EXISTS knowledge_documents (
  ...
  CONSTRAINT fk_knowledge_documents_custom_hazard FOREIGN KEY (custom_hazard_id) REFERENCES custom_hazards(id) ON DELETE SET NULL,
  ...
  INDEX ix_knowledge_documents_custom_hazard_id (custom_hazard_id),
...
INSERT IGNORE INTO evaluation_questions (category, sort_order, chart_title, question, active) VALUES
