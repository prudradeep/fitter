...
class ChatMitigationCreationMixin:
    ...
    def _system_inquiry_payload_annotations(
        ...
        for index, annotation in enumerate(session.system_inquiry_annotations or [], start=1):
            ...
            item.setdefault("created_at", ChatMitigationCreationMixin._system_inquiry_created_at())
    ...
    def _system_inquiry_probe_metadata(probe_id: str) -> dict[str, object]:
        ...
        enriched["library_version"] = (
            ChatMitigationCreationMixin._system_inquiry_library_version()
        )
        enriched.setdefault(
            "source_refs",
            [
