...
class ChatPhase(AppStrEnum):
    ...
    MITIGATION_MECHANISM_SELECTION = "mitigation_mechanism_selection"
    MITIGATION_POLICY_CONFIRMATION = "mitigation_policy_confirmation"
    MITIGATION_POLICY_REFERENCE = "mitigation_policy_reference"
    MITIGATION_POLICY_RETRY = "mitigation_policy_retry"
    MITIGATION_POLICY_CLARIFICATION = "mitigation_policy_clarification"
    MITIGATION_MECHANISM_REFLECTION_REVIEW = "mitigation_mechanism_reflection_review"
    MITIGATION_MECHANISM_REFLECTION_INPUT = "mitigation_mechanism_reflection_input"
    MITIGATION_POLICY_EFFECT_REVIEW = "mitigation_policy_effect_review"
    MITIGATION_POLICY_EFFECT_MITIGATION = "mitigation_policy_effect_mitigation"
    MITIGATION_POLICY_EFFECT_DISAGREEMENT = "mitigation_policy_effect_disagreement"
    MITIGATION_MECHANISM_CONFIRMATION = "mitigation_mechanism_confirmation"
    ...
    MITIGATION_DG_EVIDENCE_INPUT = "mitigation_dg_evidence_input"
    MITIGATION_DG_SUMMARY_REVIEW = "mitigation_dg_summary_review"
    MITIGATION_EQUITY = "mitigation_equity"
    MITIGATION_FINAL_SUMMARY_REVIEW = "mitigation_final_summary_review"
    ...
    CUSTOM_HAZARD_EVIDENCE_REFLECTION_CONFIRMATION = "custom_hazard_evidence_reflection_confirmation"
    CUSTOM_HAZARD_EVIDENCE_REFLECTION_INPUT = "custom_hazard_evidence_reflection_input"
    ...
    CUSTOM_HAZARD_POLICY_DETAILS_CONFIRMATION = "custom_hazard_policy_details_confirmation"
