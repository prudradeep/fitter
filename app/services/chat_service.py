...
class ChatService(
    ...
    def _custom_hazard_state_handlers(self) -> CustomHazardHandlers:
        return CustomHazardHandlers(
            ...
            confirm_policy_details=self._handle_custom_hazard_policy_details_confirmation,
            confirm_causal_linkage=self._handle_custom_hazard_causal_linkage_confirmation,
            capture_reason=self._capture_hazard_reason,
            confirm_evidence_reflection=self._handle_hazard_evidence_reflection_confirmation,
            capture_evidence_reflection=self._capture_hazard_evidence_reflection,
