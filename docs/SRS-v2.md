...
Platform co-created hazard confidence scoring uses six weighted dimensions: hazard definition `0.25`, twin-transition policy fit `0.20`, policy-objective fit `0.15`, selected sector fit `0.15`, country/region fit `0.10`, and affected population groups `0.15`. Policy-objective fit is mandatory and checks the hazard against the objective defined for the selected sector. [app/services/custom_hazard_validation.py :: DIMENSION_WEIGHTS] [app/services/custom_hazard_validation.py :: SECTOR_POLICY_OBJECTIVES]
